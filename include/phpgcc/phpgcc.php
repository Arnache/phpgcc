...
void explainSyntax() {
    std::cout << "Syntax: " << progName <<" [textfiles] [options]\n";
...
$content .= '
    std::cout << std::endl;
    std::cout << "\'" << progName << " --help\' for a more detailed description" << std::endl;
    std::cout << "\'" << progName << " --options\' for options description" << std::endl;
}
...
void help() {
    std::cout << progName << ", ©" << year << " Arnaud Chéritat\n\n";
    describe();
    std::cout << "Syntax: " << progName << " [textfiles] [options]\n";
    ...
    std::cout << "  command line options supersede textfile options (even textfiles appearing\n";
...
$content .= '
  ...
  t.key = "Software";
  t.text = "'.$ccName.' version '.$version.' ©'.$year.' Chéritat";
...
if($colorType=='ps') {
  ...
  file << "% Software: '.$ccName.' ©'.$year.' Chéritat\n";
