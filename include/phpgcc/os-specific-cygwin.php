...
If $phpgcc_installed is true then phpgcc.php will look for the phpgcc .cc include files in the include folders searched by gcc using #include <$phpgcc_lib_dirname/file.cc> or #include <file.cc> if #include <$phpgcc_lib_dirname/file.cc> is empty
